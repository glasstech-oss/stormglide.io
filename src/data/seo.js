...
export const seoRoutes = [
  ...
  },
  {
    ...
    description: 'Real business systems already in use in Ghana — HR & payroll management, dental practice management, freight & logistics tracking, health monitoring, and spa booking. See what replacing WhatsApp and Excel actually looks like.',
    h1: 'Systems already solving these problems for real businesses',
    kicker: 'Stormglide products',
    summary: 'Our products solve practical operational problems across HR, dental care, freight, health, spa booking, and digital commerce.',
